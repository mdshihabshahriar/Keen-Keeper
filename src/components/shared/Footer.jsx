    ...
    return (
        <div className='mt-20 bg-[#244D3F]'>
            <div className='text-center space-y-4'>
                <img src={footerLogo} className='mx-auto pt-20 w-80' alt="" />
            ...
            <div className='w-9/12 mx-auto mt-4'>
                ...
                <div className='flex flex-col-reverse md:flex-row items-center justify-between pb-7'>
                    <div>
                        <p className='text-[#FAFAFA] text-[16px] mt-4 md:mt-0'>© 2026 KeenKeeper. All rights reserved.</p>
                    </div>
